...
struct AdsHomeScreen: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 14) {
                ...
                HStack(spacing: 10) {
                    ...
                    Button { showAddressSheet = true } label: {
                        topPill(
                            title: lang.isArabic ? "أضف عنوانك" : "Add your address",
                    ...
                    Button {
                        ...
                        topPill(
                            title: lang.isArabic ? "إعلان مجاني" : "Free Ad",
                    ...
                    Button { showPaidSheet = true } label: {
                        topPill(
                            title: lang.isArabic ? "مدفوع" : "Paid",
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Text(lang.isArabic ? "إعلاناتك" : "Your Ads")
                            .font(.title3.bold())
                            .padding(.horizontal, 14)
                            .padding(.top, 6)
                        ...
                        if adsStore.myAds.isEmpty {
                            RoundedRectangle(cornerRadius: 16)
                                ...
                                .frame(height: 180)
                                .overlay(
                                    Text(lang.isArabic ? "لا يوجد إعلانات بعد" : "No ads yet")
                                        .foregroundStyle(.secondary)
                                )
                                .padding(.horizontal, 14)
                                .padding(.top, 6)
        ...
        .sheet(isPresented: $showPaidSheet) {
            NavigationStack {
                SelectAdPlanView()
                    ...
                    .environmentObject(adsStore) // ✅ مهم
            }
        }

        // Free (treated like Prime Featured)
        ...
        // Alert
        .alert(lang.isArabic ? "تم استخدام الهدية المجانية" : "Free gift already used",
    ...
    private func adCard(_ ad: HMPAd) -> some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            HStack {
                ...
                Spacer()
                Text(ad.isActive ? (lang.isArabic ? "نشط" : "Active") : (lang.isArabic ? "منتهي" : "Expired"))
            ...
            HStack(spacing: 10) {
                if ad.isFeatured {
                    Label(lang.isArabic ? "مميز" : "Featured", systemImage: "star.fill")
                        .font(.caption.weight(.semibold))
